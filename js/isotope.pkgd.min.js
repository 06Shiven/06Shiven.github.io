                        ...
                        for (var n = o.call(arguments, 1), a = 0, u = this.length; u > a; a++) {
                            ...
                            if (h)
                                if (t.isFunction(h[e]) && "_" !== e.charAt(0)) {
                                    ...
                                    i("no such method '" + e + "' for " + r + " instance");
                            else
                                i("cannot call methods on " + r + " prior to initialization; attempted to call '" + e + "'")
                        }
                        return this
                    }
    ...
    function o(e) {
        ...
        return function(h) {
            ...
            h && "object" == typeof h && h.nodeType) {
                ...
                var T = i(f.height);
                return !1 !== T && (l.height = T + (b ? 0 : I + E)),
                l.innerWidth = l.width - (_ + x),
                l.innerHeight = l.height - (I + E),
                l.outerWidth = l.width + z,
                l.outerHeight = l.height + L,
                l
            }
        }
    }
...
function(t, e) {
    ...
    r.prototype.getPosition = function() {
        ...
        u = isNaN(u) ? 0 : u,
        p = isNaN(p) ? 0 : p,
        u -= i ? s.paddingLeft : s.paddingRight,
...
function(t, e) {
    ...
    var f = function() {
        return function(t) {
            if ("string" != typeof t)
                return t;
            var e, i, o = u(t).split(" "), n = o[0], r = n.match(/^\[(.+)\]$/), s = r && r[1], a = (i = n,
            (e = s) ? function(t) {
    ...
    h.prototype._sort = function() {
        ...
        if (i) {
            ...
            i != this.sortHistory[0] && this.sortHistory.unshift(i)
        }
    }
    ,
